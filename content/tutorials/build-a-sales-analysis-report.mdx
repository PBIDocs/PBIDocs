...
Want to build a star schema a different way? [Build a Product Usage Dashboard on a Fabric Lakehouse](/tutorials/build-a-fabric-lakehouse-dashboard) uses a notebook and Direct Lake mode instead of Power Query and Import.
