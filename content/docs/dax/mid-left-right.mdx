...
Need the rest of DAX's text functions in one place — CONCATENATEX, SUBSTITUTE, FORMAT, EXACT? See the [DAX Text Functions Cheat Sheet](/blog/dax-text-functions-cheat-sheet).
