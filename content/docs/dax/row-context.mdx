...
|---|---|---|
| Created by Calculated Columns | âœ… | âŒ |
| Created by Measures | âŒ | âœ… |
| Created by Iterator Functions | âœ… | âŒ |
| Created by Report Filters | âŒ | âœ… |
| Created by Slicers | âŒ | âœ… |
| Modified by `CALCULATE()` | âžœ Converted | âœ… |
