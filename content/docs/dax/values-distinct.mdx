...
Using `VALUES()` directly as a measure instead of feeding it to something else? See ["a table of multiple values was supplied"](/blog/table-of-multiple-values-supplied-error) for why that breaks the moment more than one value is in context.
