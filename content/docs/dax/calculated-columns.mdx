...
Getting "a single value for column cannot be determined" when the same formula moves from a calculated column to a measure? See [A Single Value for Column Cannot Be Determined](/blog/single-value-column-cannot-be-determined) for why.
