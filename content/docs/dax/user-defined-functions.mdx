...
New to UDFs? See [DAX User-Defined Functions Are Here — What You Need to Know](/blog/dax-user-defined-functions-explained) for the shape of the feature before diving into the full syntax above.
