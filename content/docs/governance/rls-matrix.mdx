...
A different kind of matrix: [Build a Risk Register and Risk Matrix Dashboard](/tutorials/build-a-risk-register-dashboard) builds an actual 5x5 likelihood/impact matrix in Power BI.
