...
RLS filtering correctly in Desktop but not after publishing? See [Row-Level Security Works in Desktop But Not in the Service](/blog/rls-works-in-desktop-not-in-service) for the four usual causes.
