...
Hitting an error building a relationship? See [Column Contains a Duplicate Value](/blog/column-contains-duplicate-value-error) for how to find and fix it.

A visual failing with "Couldn't load the data for this visual"? An inactive or ambiguous relationship is one of the four usual causes — see [Couldn't Load the Data for This Visual](/blog/couldnt-load-data-for-this-visual).
