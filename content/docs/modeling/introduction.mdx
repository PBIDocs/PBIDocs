...
- `<code>Fact Tables</code>` â€” Store measurable business events.
- `<code>Dimension Tables</code>` â€” Provide descriptive information for filtering.
- `<code>Relationships</code>` â€” Connect tables together.
- `<code>Measures</code>` â€” Calculate business logic using DAX.
