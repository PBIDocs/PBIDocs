...
See it applied end to end: [Build a Requirements Traceability Matrix Dashboard](/tutorials/build-a-requirements-traceability-matrix) uses a real bridge table to connect requirements to test cases, start to finish.
