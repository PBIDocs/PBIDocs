...
Getting "There were too many elements in the enumeration to complete the operation"? See [that error explained](/blog/too-many-elements-in-enumeration-pivot-error) — it's this exact duplicate-key situation.
