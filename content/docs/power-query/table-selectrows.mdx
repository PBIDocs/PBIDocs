...
- [Table.FirstN() & Table.Skip()](/docs/power-query/table-firstn-skip) — a real filter over every row, unlike FirstN's condition form
- [Value.Type(), Value.Is() & Comparing to null](/docs/power-query/value-type-null) — filtering on `= null` works as expected in M, unlike SQL
