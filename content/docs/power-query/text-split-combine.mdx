...
Try typing two separators back to back, or changing how many appear — the item count and the empty-string chips update live instead of just being described.
...
- [Table.SplitColumn() & Table.CombineColumns()](/docs/power-query/table-splitcolumn-combinecolumns) — the same split/combine idea applied to whole table columns
