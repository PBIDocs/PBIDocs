...
| Function | Description |
|---|---|
| [try ... otherwise](/docs/power-query/editor#adding-error-handling-the-ui-doesnt-expose) | Catches an error from an expression, substituting a fallback value instead of failing the step. |
