      ...
      <div className="prose-sm max-w-none space-y-10 text-fd-muted-foreground [&_h2]:text-fd-foreground [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:mb-3 [&_p]:leading-relaxed [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:space-y-1.5 [&_li]:leading-relaxed">
        ...
        <section>
          ...
          <p>
            ...
            free up to a daily limit, with a paid Pro subscription available for a higher limit.
            {appName} isn&apos;t affiliated with, endorsed by, or sponsored by Microsoft.
          </p>
        </section>

        <section>
          <h2>Free Tier and Pro Subscription</h2>
          <ul>
            <li>Both AI tools are usable without an account, up to 5 requests a day each.</li>
            <li>
              Pro is a $5/month recurring subscription that raises both limits to 200 requests a
              day each. It renews automatically each month until cancelled.
            </li>
            <li>
            ...
            <li>
              You can cancel anytime from the billing portal, linked wherever your subscription
              status is shown. Cancelling stops future renewal; access continues until the end
              of the billing period already paid for.
            </li>
            <li>
              Charges are non-refundable except where required by law. If a charge was made in
              error, contact{' '}
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              It isn&apos;t a substitute for understanding what a formula does before using it
              in a real report.
            </li>
            <li>
              You&apos;re responsible for reviewing and testing anything generated before relying
              on it, especially in a production report or dataset.
            </li>
          </ul>
          <p>
        ...
        <section>
          ...
          <ul>
            <li>
              Circumvent the daily rate limits (e.g., automated scripting, rotating identifiers,
              or other means of evading the limit rather than subscribing).
            </li>
        ...
        <section>
          ...
          <p>
            ...
            to ask. DAX and Power Query M code generated for you by the AI tools, and any code
            snippets shown in the docs, are yours to use freely in your own work.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            and uses Anthropic&apos;s API to generate AI tool responses. Each of these providers
            processes the data necessary to perform its function (payment details with Stripe,
            your prompt with Anthropic) under its own terms and privacy practices. See{' '}
        ...
        <section>
          ...
          <p>
            ...
            without warranties of any kind, express or implied. {appName} doesn&apos;t guarantee
            the service will be uninterrupted, error-free, or that its content is accurate or
        ...
        <section>
          ...
          <p>
            To the fullest extent permitted by law, {appName} isn&apos;t liable for any indirect,
            incidental, or consequential damages arising from your use of the site or its
            tools — including damages resulting from relying on AI-generated DAX or Power Query
            M in a report or dataset without independently reviewing it.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            These terms may be updated as the site changes. Meaningful changes will be reflected
            here, with the date at the top kept current. Continuing to use the site after a
